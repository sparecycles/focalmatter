...
function prop(definition) { this.definition = definition; }

classify.property = function(definition) {
  return new prop(definition);
}
...
function classify(name, definition) {
  ...
  default:
    ...
    if(value instanceof prop) {
      Object.defineProperty(klass, key, value.definition);
    } else {
